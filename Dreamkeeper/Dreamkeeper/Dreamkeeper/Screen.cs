...
namespace Dreamkeeper
{
    public class Screen
    {
        ...
        public virtual void ReloadContent()
        {
            ...
            Program.game.level1 = new Level(Program.game.Content, Program.game.MenuSwitchEvent, graphics, Program.game.Content.Load<Texture2D>("Level1"), Program.game.difficulty, new Enemy("Crow", Program.game.Content.Load<Texture2D>("Crow-Fly-Right"), Program.game.Content.Load<Texture2D>("Crow-Fly-Left"), new Vector2(graphics.PreferredBackBufferWidth, 100), 1, new Vector2(-2, 0), Program.game.Content, graphics.GraphicsDevice), 1000);
            Program.game.level2 = new Level(Program.game.Content, Program.game.MenuSwitchEvent, graphics, Program.game.Content.Load<Texture2D>("Level2Wip"), Program.game.difficulty, new Enemy("Crow", Program.game.Content.Load<Texture2D>("Crow-Fly-Right"), Program.game.Content.Load<Texture2D>("Crow-Fly-Left"), new Vector2(graphics.PreferredBackBufferWidth, 100), 2, new Vector2(-2, 0), Program.game.Content, graphics.GraphicsDevice), 1000);
            Program.game.level3 = new Level(Program.game.Content, Program.game.MenuSwitchEvent, graphics, Program.game.Content.Load<Texture2D>("Level3Wip"), Program.game.difficulty, new Enemy("Crow", Program.game.Content.Load<Texture2D>("Crow-Fly-Right"), Program.game.Content.Load<Texture2D>("Crow-Fly-Left"), new Vector2(graphics.PreferredBackBufferWidth, 100), 3, new Vector2(-2, 0), Program.game.Content, graphics.GraphicsDevice), 1000);
        }
