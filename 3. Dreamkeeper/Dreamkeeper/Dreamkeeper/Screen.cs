...
namespace Dreamkeeper
{
    public class Screen
    {
        ...
        public virtual void ReloadContent()
        {
            ...
            Program.game.level2 = new LevelJack(Program.game.Content, Program.game.MenuSwitchEvent, graphics, Program.game.Content.Load<Texture2D>("Level2"), Program.game.difficulty, new EnemyJack("Cricket", Program.game.Content.Load<Texture2D>("cricketRight"), Program.game.Content.Load<Texture2D>("cricketLeft"), new Vector2(graphics.PreferredBackBufferWidth, 100), 2, new Vector2(-2, 0), Program.game.Content, graphics.GraphicsDevice), 1000, 60);
            ...
            Program.game.level8 = new LevelJack(Program.game.Content, Program.game.MenuSwitchEvent, graphics, Program.game.Content.Load<Texture2D>("Level8"), Program.game.difficulty, new EnemyJack("Crow", Program.game.Content.Load<Texture2D>("Crow-Fly-Right"), Program.game.Content.Load<Texture2D>("Crow-Fly-Left"), new Vector2(graphics.PreferredBackBufferWidth, 100), 3, new Vector2(-2, 0), Program.game.Content, graphics.GraphicsDevice), 1000, 60);
            ...
            Program.game.level10 = new LevelBoss(Program.game.Content, Program.game.MenuSwitchEvent, graphics, Program.game.Content.Load<Texture2D>("Level10"), Program.game.difficulty, new EnemyBoss("Void King", Program.game.Content.Load<Texture2D>("boss"), Program.game.Content.Load<Texture2D>("boss"), Program.game.Content.Load<Texture2D>("tentacleShield"), Program.game.Content.Load<Texture2D>("tentacleShield"), new Vector2(graphics.PreferredBackBufferWidth, 100), 10, new Vector2(-2, 0), Program.game.Content, graphics.GraphicsDevice), 1000, 120);
        }
