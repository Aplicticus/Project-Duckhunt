...
namespace Dreamkeeper
{
    public class Screen
    {
        ...
        public virtual void ReloadContent()
        {
            ...
            Program.game.intro2_1 = new Intro(Program.game.MenuSwitchEvent, graphics, Program.game.spriteBatch, Program.game.Content.Load<SpriteFont>("MenuFont"), Program.game.Content.Load<Texture2D>("Level2Wip"), "TextFiles\\Intro2_1.txt", Color.Black);
            Program.game.intro2_2 = new Intro(Program.game.MenuSwitchEvent, graphics, Program.game.spriteBatch, Program.game.Content.Load<SpriteFont>("MenuFont"), Program.game.Content.Load<Texture2D>("Level2Wip"), "TextFiles\\Intro2_2.txt", Color.Black);
            ...
            Program.game.intro4_1 = new Intro(Program.game.MenuSwitchEvent, graphics, Program.game.spriteBatch, Program.game.Content.Load<SpriteFont>("MenuFont"), Program.game.Content.Load<Texture2D>("Level4Wip"), "TextFiles\\Intro4_1.txt", Color.Black);
            Program.game.intro4_2 = new Intro(Program.game.MenuSwitchEvent, graphics, Program.game.spriteBatch, Program.game.Content.Load<SpriteFont>("MenuFont"), Program.game.Content.Load<Texture2D>("Level4Wip"), "TextFiles\\Intro4_2.txt", Color.Black);
            Program.game.intro5_1 = new Intro(Program.game.MenuSwitchEvent, graphics, Program.game.spriteBatch, Program.game.Content.Load<SpriteFont>("MenuFont"), Program.game.Content.Load<Texture2D>("Level5Wip"), "TextFiles\\Intro5_1.txt", Color.Black);
            Program.game.intro5_2 = new Intro(Program.game.MenuSwitchEvent, graphics, Program.game.spriteBatch, Program.game.Content.Load<SpriteFont>("MenuFont"), Program.game.Content.Load<Texture2D>("Level5Wip"), "TextFiles\\Intro5_2.txt", Color.Black);
            Program.game.intro6_1 = new Intro(Program.game.MenuSwitchEvent, graphics, Program.game.spriteBatch, Program.game.Content.Load<SpriteFont>("MenuFont"), Program.game.Content.Load<Texture2D>("Level6Wip"), "TextFiles\\Intro6_1.txt", Color.Black);
            Program.game.intro6_2 = new Intro(Program.game.MenuSwitchEvent, graphics, Program.game.spriteBatch, Program.game.Content.Load<SpriteFont>("MenuFont"), Program.game.Content.Load<Texture2D>("Level6Wip"), "TextFiles\\Intro6_2.txt", Color.Black);
            Program.game.intro7_1 = new Intro(Program.game.MenuSwitchEvent, graphics, Program.game.spriteBatch, Program.game.Content.Load<SpriteFont>("MenuFont"), Program.game.Content.Load<Texture2D>("Level7Wip"), "TextFiles\\Intro7_1.txt", Color.Black);
            Program.game.intro7_2 = new Intro(Program.game.MenuSwitchEvent, graphics, Program.game.spriteBatch, Program.game.Content.Load<SpriteFont>("MenuFont"), Program.game.Content.Load<Texture2D>("Level7Wip"), "TextFiles\\Intro7_2.txt", Color.Black);
            Program.game.intro8_1 = new Intro(Program.game.MenuSwitchEvent, graphics, Program.game.spriteBatch, Program.game.Content.Load<SpriteFont>("MenuFont"), Program.game.Content.Load<Texture2D>("Level8Wip"), "TextFiles\\Intro8_1.txt", Color.Black);
            Program.game.intro8_2 = new Intro(Program.game.MenuSwitchEvent, graphics, Program.game.spriteBatch, Program.game.Content.Load<SpriteFont>("MenuFont"), Program.game.Content.Load<Texture2D>("Level8Wip"), "TextFiles\\Intro8_2.txt", Color.Black);
            Program.game.intro9_1 = new Intro(Program.game.MenuSwitchEvent, graphics, Program.game.spriteBatch, Program.game.Content.Load<SpriteFont>("MenuFont"), Program.game.Content.Load<Texture2D>("Level9Wip"), "TextFiles\\Intro9_1.txt", Color.Black);
            Program.game.intro9_2 = new Intro(Program.game.MenuSwitchEvent, graphics, Program.game.spriteBatch, Program.game.Content.Load<SpriteFont>("MenuFont"), Program.game.Content.Load<Texture2D>("Level9Wip"), "TextFiles\\Intro9_2.txt", Color.Black);
            Program.game.intro10_1 = new Intro(Program.game.MenuSwitchEvent, graphics, Program.game.spriteBatch, Program.game.Content.Load<SpriteFont>("MenuFont"), Program.game.Content.Load<Texture2D>("Level10Wip-Recovered"), "TextFiles\\Intro10_1.txt", Color.Black);
            Program.game.intro10_2 = new Intro(Program.game.MenuSwitchEvent, graphics, Program.game.spriteBatch, Program.game.Content.Load<SpriteFont>("MenuFont"), Program.game.Content.Load<Texture2D>("Level10Wip-Recovered"), "TextFiles\\Intro10_2.txt", Color.Black);
