...
{    
    ...
    {
        #region Variables
        private Ammonitions ammo { get; set; }
        internal int damage { get; private set; }
        internal Texture2D texture { get; private set; }
        internal Texture2D hitTexture { get; private set; }
        internal bool hit { get; private set; }
        internal bool enemyHit { get; set; }
        internal AnimatedSprite travelAnimation { get; private set; }
        internal AnimatedSprite hitAnimation { get; private set; }
