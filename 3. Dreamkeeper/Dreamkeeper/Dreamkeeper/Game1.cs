...
namespace Dreamkeeper
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        public Level level1, level3, level4, level5, level6, level7, level9;
        public LevelJack level2, level8;
        public LevelBoss level10;
        ...
        protected override void LoadContent()
        {
            ...
            intro2_1 = new Intro(MenuSwitchEvent, graphics, spriteBatch, Content.Load<SpriteFont>("MenuFont"), Content.Load<Texture2D>("level2"), "TextFiles\\Intro2_1.txt", Color.Black);
            intro2_2 = new Intro(MenuSwitchEvent, graphics, spriteBatch, Content.Load<SpriteFont>("MenuFont"), Content.Load<Texture2D>("level2"), "TextFiles\\Intro2_2.txt", Color.Black);
            ...
            intro4_1 = new Intro(MenuSwitchEvent, graphics, spriteBatch, Content.Load<SpriteFont>("MenuFont"), Content.Load<Texture2D>("level4"), "TextFiles\\Intro4_1.txt", Color.Black);
            intro4_2 = new Intro(MenuSwitchEvent, graphics, spriteBatch, Content.Load<SpriteFont>("MenuFont"), Content.Load<Texture2D>("level4"), "TextFiles\\Intro4_2.txt", Color.Black);
            intro5_1 = new Intro(MenuSwitchEvent, graphics, spriteBatch, Content.Load<SpriteFont>("MenuFont"), Content.Load<Texture2D>("level5"), "TextFiles\\Intro5_1.txt", Color.Black);
            intro5_2 = new Intro(MenuSwitchEvent, graphics, spriteBatch, Content.Load<SpriteFont>("MenuFont"), Content.Load<Texture2D>("level5"), "TextFiles\\Intro5_2.txt", Color.Black);
            intro6_1 = new Intro(MenuSwitchEvent, graphics, spriteBatch, Content.Load<SpriteFont>("MenuFont"), Content.Load<Texture2D>("level6"), "TextFiles\\Intro6_1.txt", Color.Black);
            intro6_2 = new Intro(MenuSwitchEvent, graphics, spriteBatch, Content.Load<SpriteFont>("MenuFont"), Content.Load<Texture2D>("level6"), "TextFiles\\Intro6_2.txt", Color.Black);
            intro7_1 = new Intro(MenuSwitchEvent, graphics, spriteBatch, Content.Load<SpriteFont>("MenuFont"), Content.Load<Texture2D>("level7"), "TextFiles\\Intro7_1.txt", Color.Black);
            intro7_2 = new Intro(MenuSwitchEvent, graphics, spriteBatch, Content.Load<SpriteFont>("MenuFont"), Content.Load<Texture2D>("level7"), "TextFiles\\Intro7_2.txt", Color.Black);
            intro8_1 = new Intro(MenuSwitchEvent, graphics, spriteBatch, Content.Load<SpriteFont>("MenuFont"), Content.Load<Texture2D>("level8"), "TextFiles\\Intro8_1.txt", Color.Black);
            intro8_2 = new Intro(MenuSwitchEvent, graphics, spriteBatch, Content.Load<SpriteFont>("MenuFont"), Content.Load<Texture2D>("level8"), "TextFiles\\Intro8_2.txt", Color.Black);
            intro9_1 = new Intro(MenuSwitchEvent, graphics, spriteBatch, Content.Load<SpriteFont>("MenuFont"), Content.Load<Texture2D>("level9"), "TextFiles\\Intro9_1.txt", Color.Black);
            intro9_2 = new Intro(MenuSwitchEvent, graphics, spriteBatch, Content.Load<SpriteFont>("MenuFont"), Content.Load<Texture2D>("level9"), "TextFiles\\Intro9_2.txt", Color.Black);
            intro10_1 = new Intro(MenuSwitchEvent, graphics, spriteBatch, Content.Load<SpriteFont>("MenuFont"), Content.Load<Texture2D>("level10"), "TextFiles\\Intro10_1.txt", Color.Black);
            intro10_2 = new Intro(MenuSwitchEvent, graphics, spriteBatch, Content.Load<SpriteFont>("MenuFont"), Content.Load<Texture2D>("level10"), "TextFiles\\Intro10_2.txt", Color.Black);
            ...
            level2 = new LevelJack(Content, MenuSwitchEvent, graphics, Content.Load<Texture2D>("Level2"), difficulty, new EnemyJack("Cricket", Content.Load<Texture2D>("cricketRight"), Content.Load<Texture2D>("cricketLeft"), new Vector2(graphics.PreferredBackBufferWidth, 100), 2, new Vector2(-2, 0), Content, graphics.GraphicsDevice), 1000, 60);
            ...
            level4 = new Level(Content, MenuSwitchEvent, graphics, Content.Load<Texture2D>("Level4"), difficulty, new Enemy("Crow", Content.Load<Texture2D>("Crow-Fly-Right"), Content.Load<Texture2D>("Crow-Fly-Left"), new Vector2(graphics.PreferredBackBufferWidth, 100), 3, new Vector2(-2, 0), Content, graphics.GraphicsDevice), 1000, 60);
            level5 = new Level(Content, MenuSwitchEvent, graphics, Content.Load<Texture2D>("Level5"), difficulty, new Enemy("Crow", Content.Load<Texture2D>("Crow-Fly-Right"), Content.Load<Texture2D>("Crow-Fly-Left"), new Vector2(graphics.PreferredBackBufferWidth, 100), 3, new Vector2(-2, 0), Content, graphics.GraphicsDevice), 1000, 60);
            level6 = new Level(Content, MenuSwitchEvent, graphics, Content.Load<Texture2D>("Level6"), difficulty, new Enemy("Crow", Content.Load<Texture2D>("Crow-Fly-Right"), Content.Load<Texture2D>("Crow-Fly-Left"), new Vector2(graphics.PreferredBackBufferWidth, 100), 3, new Vector2(-2, 0), Content, graphics.GraphicsDevice), 1000, 60);
            level7 = new Level(Content, MenuSwitchEvent, graphics, Content.Load<Texture2D>("Level7"), difficulty, new Enemy("Crow", Content.Load<Texture2D>("Crow-Fly-Right"), Content.Load<Texture2D>("Crow-Fly-Left"), new Vector2(graphics.PreferredBackBufferWidth, 100), 3, new Vector2(-2, 0), Content, graphics.GraphicsDevice), 1000, 60);
            level8 = new LevelJack(Content, MenuSwitchEvent, graphics, Content.Load<Texture2D>("Level8"), difficulty, new EnemyJack("Crow", Content.Load<Texture2D>("Crow-Fly-Right"), Content.Load<Texture2D>("Crow-Fly-Left"), new Vector2(graphics.PreferredBackBufferWidth, 100), 3, new Vector2(-2, 0), Content, graphics.GraphicsDevice), 1000, 60);
            level9 = new Level(Content, MenuSwitchEvent, graphics, Content.Load<Texture2D>("Level9"), difficulty, new Enemy("Crow", Content.Load<Texture2D>("Crow-Fly-Right"), Content.Load<Texture2D>("Crow-Fly-Left"), new Vector2(graphics.PreferredBackBufferWidth, 100), 3, new Vector2(-2, 0), Content, graphics.GraphicsDevice), 1000, 60);
            level10 = new LevelBoss(Content, MenuSwitchEvent, graphics, Content.Load<Texture2D>("Level10"), difficulty, new EnemyBoss("Void King", Content.Load<Texture2D>("boss"), Content.Load<Texture2D>("boss"), Content.Load<Texture2D>("tentacleShield"), Content.Load<Texture2D>("tentacleShield"), new Vector2(graphics.PreferredBackBufferWidth, 100), 10, new Vector2(-2, 0), Content, graphics.GraphicsDevice), 1000, 120);
